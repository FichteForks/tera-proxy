...
function InitCommandBase(mod) {
	if(map.has(mod.dispatch.HACK_UNIQUE_KEY_HACK))
        return map.get(mod.dispatch.HACK_UNIQUE_KEY_HACK);

	const instance = new CommandBase(mod);
	map.set(mod.dispatch.HACK_UNIQUE_KEY_HACK, instance);
	return instance;
}
